...
Catalog.Map = {helpLinks: [], active: false, addHelpLink: function (linkElement, title, actualPrice, msrpPrice, addToCartLink) {
    ...
    var helpBox = $('map-popup'), isIE6 = typeof document.body.style.maxHeight === "undefined";
    if (!helpBox) {
        return;
    }
    var bodyNode = $$('body')[0];
    ...
    if (this != Catalog.Map && Catalog.Map.active != this.link) {
        ...
        var mapText = $('map-popup-text'), mapTextWhatThis = $('map-popup-text-what-this'), mapContent = $('map-popup-content');
    ...
    productAddToCartForm.submit = function (button, url) {
        ...
        if (window.opener) {
            ...
            new Ajax.Request(this.form.action, {parameters: {isAjax: 1, method: 'GET'}, onSuccess: function (transport) {
                window.opener.focus();
