        ...
        <div class="product-box-info">
            <div class="product-box-bg">
                <h3 class="product-name"><a
                        href="http://livedemo00.template-help.com/magento_42124/robin-fabric-button-earrings.html"
                        title="Robin fabric button earrings">Robin fabric button earrings</a></h3>
...
<span class="price">$23.19</span> </span>
    ...
    <li class="item">
        ...
        <div class="product-box-info">
            <div class="product-box-bg">
                <h3 class="product-name"><a
                        href="http://livedemo00.template-help.com/magento_42124/pancy-blossom-bracelet.html"
                        title="Pancy blossom bracelet">Pancy blossom bracelet</a></h3>
...
<span class="price">$24.99</span> </span>
    ...
    <li class="item last">
        ...
        <div class="product-box-info">
            <div class="product-box-bg">
                <h3 class="product-name"><a
                        href="http://livedemo00.template-help.com/magento_42124/original-bird-red.html"
                        title="Original bird red">Original bird red</a></h3>

                <div class="price-box">
<span class="regular-price" id="product-price-44-new">
...
<ul class="products-grid">
    <li class="item first">
        ...
        <div class="product-box-info">
            <div class="product-box-bg">
                <h3 class="product-name"><a
                        href="http://livedemo00.template-help.com/magento_42124/pearl-pendants-adult-and-child-on-dish.html"
                        title="Pearl pendants adult and child on dish">Pearl pendants adult and
                        child on dish</a></h3>
...
<span class="price">$32.19</span> </span>
    ...
    <li class="item">
        ...
        <div class="product-box-info">
            <div class="product-box-bg">
                <h3 class="product-name"><a
                        href="http://livedemo00.template-help.com/magento_42124/square.html"
                        title="SQUARE">SQUARE</a></h3>

                <div class="price-box">
<span class="regular-price" id="product-price-47-new">
<span class="price">$19.99</span> </span>
    ...
    <li class="item last">
        ...
        <div class="product-box-info">
            <div class="product-box-bg">
                <h3 class="product-name"><a
                        href="http://livedemo00.template-help.com/magento_42124/original-neclaces.html"
                        title="Original Neclaces">Original Neclaces</a></h3>
...
<ul class="products-grid">
    <li class="item first">
        ...
        <div class="product-box-info">
            <div class="product-box-bg">
                <h3 class="product-name"><a
                        href="http://livedemo00.template-help.com/magento_42124/original-bird.html"
                        title="Original bird">Original bird</a></h3>

                <div class="price-box">
<span class="regular-price" id="product-price-43-new">
<span class="price">$28.90</span> </span>
    ...
    <li class="item">
        ...
        <div class="product-box-info">
            <div class="product-box-bg">
                <h3 class="product-name"><a
                        href="http://livedemo00.template-help.com/magento_42124/pearl-cudblaz.html"
                        title="Pearl cudblaz">Pearl cudblaz</a></h3>

                <div class="price-box">
<span class="regular-price" id="product-price-51-new">
<span class="price">$34.99</span> </span>
    ...
    <li class="item last">
        ...
        <div class="product-box-info">
            <div class="product-box-bg">
                <h3 class="product-name"><a
                        href="http://livedemo00.template-help.com/magento_42124/personalised-star-charm-bracelet.html"
                        title="Personalised Star Charm Bracelet">Personalised Star Charm
                        Bracelet</a></h3>

                <div class="price-box">
<span class="regular-price" id="product-price-46-new">
