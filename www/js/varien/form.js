...
VarienForm.prototype = {initialize: function (formId, firstFieldFocus) {
    ...
    if (element.value) {
        ...
        if (this.cache[element.id]['data'][element.value]) {
            ...
            new Ajax.Request(this.cache[this.currLoader]['dataUrl'], {method: 'post', parameters: {"parent": element.value}, onComplete: this.reloadChildren.bind(this)});
        }
    }
...
ZipUpdater.prototype = {initialize: function (country, zipElement) {
